...
```markdown
Read D:/promptita/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/promptita/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/promptita/.claude/agents/gsd-ui-checker.md for instructions.
