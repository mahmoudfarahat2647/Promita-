...
```bash
INIT=$(node "D:/promptita/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/promptita/.claude/get-shit-done/templates/spec.md.
