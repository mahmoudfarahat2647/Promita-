...
```
Task(
  prompt="Read D:/promptita/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/promptita/.claude/get-shit-done/templates/VALIDATION.md`
