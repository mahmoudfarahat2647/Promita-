...
<required_reading>
@D:/promptita/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@D:/promptita/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/promptita/.claude
                  → checks D:/promptita/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/promptita/.claude/get-shit-done
                  → writes to D:/promptita/.claude/get-shit-done/hooks/
...
@D:/promptita/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/promptita/.claude/get-shit-done/references/common-bug-patterns.md
