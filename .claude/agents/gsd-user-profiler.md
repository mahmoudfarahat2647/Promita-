...
<reference>
@D:/promptita/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/promptita/.claude/get-shit-done/references/user-profiling.md` to load:
